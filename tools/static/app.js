...
const MARKS = {
  ...
  // Indriya's own four-petal brand element, from Icon.svg - their deer is
  // only a raster favicon, and it would be mush at this size
  indriya: `<g><g transform="translate(1.53,0.89) scale(0.6545)" stroke-width="2.67"><path d="M16.0005 16.2489C12.2486 12.1305 12.2486 5.815 16.0005 1.69658C19.7524 5.815 19.7524 12.1305 16.0005 16.2489Z"/><path d="M16.7234 16.9727C20.8421 20.7243 27.1579 20.7243 31.2765 16.9727C27.1579 13.221 20.8421 13.221 16.7234 16.9727Z"/><path d="M16.0005 17.6964C19.7524 21.8148 19.7524 28.1303 16.0005 32.2487C12.2486 28.1303 12.2486 21.8148 16.0005 17.6964Z"/><path d="M15.2776 16.9727C11.1589 13.221 4.8431 13.221 0.724447 16.9727C4.8431 20.7243 11.1589 20.7243 15.2776 16.9727Z"/></g></g>`,
